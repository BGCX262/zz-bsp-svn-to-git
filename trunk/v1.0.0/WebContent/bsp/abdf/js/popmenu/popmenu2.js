...
var mpopTimer = 0;
mmenucolor='#EEEEEE';mfontcolor='MenuText';mmenuoutcolor='#EEEEEE';mmenuincolor='#EEEEEE';mmenuoutbordercolor='#EEEEEE';mmenuinbordercolor='#5A2614';mmidoutcolor='#A9DA1D';mmidincolor='#799310';mmenuovercolor='#004080';mitemedge='0';msubedge='1';mmenuunitwidth=66;mmenuitemwidth=140;mmenuheight=25;mmenuwidth='100%';mmenuadjust=0;mmenuadjustV=0;mfonts='font-family: ËÎÌו; font-size: 9pt; color: MenuText; ';mcursor='hand';
var swipeSteps = 4;
var swipemsec = 25;
      ...
      var mwb=1;
 				...
 				stringx += "mmenuitem_up();mexec("+x+","+i+"); ";
 				  if(thismenuitem.pos=="0"){
                     		...
                     		stringx+='<tr><td height="1" background="http://sc.jcwcn.com/tx/images/hr.gif" onmousemove="clearTimeout(mpopTimer);"><img height="1" width="1" src="http://sc.jcwcn.com/tx/JsHtml/none.gif" border="0"></td></tr>\n';
                     		}
                     	}stringx+='</table>\n</div>'
                     	}                     	
                }
