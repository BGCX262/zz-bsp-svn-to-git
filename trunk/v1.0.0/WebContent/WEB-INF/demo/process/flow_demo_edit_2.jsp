...
<fe:body formId="SimpleProcessDemoForm2" moduleName="demo" prompt="true" runFlow="true" >
	<form name="SimpleProcessDemoForm2" method="post" action="<%=baseURL%>/submitSimpleProcessDemo2_demo.do" style="margin: 0px" id="SimpleProcessDemoForm2">
	    <fe:topTable><fe:wfPowerTool formId="SimpleProcessDemoForm2" moduleName="demo"/></fe:topTable>
		<fe:span>
		<br />
		<center><font size=4><b>流程DEMO</b></font></center>
		<br />
		<fe:wfPageHead />
		<html:hidden name="SimpleProcessDemoForm2" property="id"styleId="id" />
			...
			<tr>
				...
				<table   cellspacing="0" cellpadding="3" width="96%" class="tform" align=center>
					<tr>
						...
						<td width="35%">
						<html:text name="SimpleProcessDemoForm2" property="name" styleId="name" size="30"styleClass="formStyleall" readonly="true" /></td>
						<td width="15%"><span id="simpleId_span">父id：</span></td>
						<td width="35%">
						<html:text name="SimpleProcessDemoForm2" property="simpleId" styleId="simpleId" size="30" styleClass="formStyleall" readonly="true" /></td>
