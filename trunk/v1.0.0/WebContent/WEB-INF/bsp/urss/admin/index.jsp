...
<link rel="stylesheet" type="text/css" href="<%=baseURL%>/bsp/abdf/skins/default/css/mian.css" >
	...
	<title>精鹰中国基础服务平台</title>
	<link href="<%=baseURL%>/bsp/abdf/skins/frame/css/fe/fe.css" rel="stylesheet" type="text/css" />
...
<BODY class="login-bg" style="overflow:hidden ">
	<DIV class=login-box>
		<form action="<%=baseURL%>/mrgLogonToSystem_urss.do" name="loginForm" id="loginForm" method="post" >
										...
										<TR>
											<TD colSpan=2>
												...
												<input style="width: 130px" name="username" class="formStyleall" type="text"  id="username"
													onkeydown="javascript:filterKey();" value="lzr">
										...
										<TR>
											<TD colSpan=2>
												...
												<input style="width: 130px" class="formStyleall" name="password" type="password" id="password"
													 onkeydown="javascript:filterKey();" value="password"><input type="hidden" name="lt" value="<%= request.getAttribute("edu.yale.its.tp.cas.lt") %>" />
											</TD>
										</TR>
										<TR>
