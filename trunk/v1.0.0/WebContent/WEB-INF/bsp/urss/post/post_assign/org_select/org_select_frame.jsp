...
<frameset rows="*,40" frameborder="no" border="0" framespacing="0">
  <frameset cols="*,75,*" frameborder="no" border="0" framespacing="0">
	  <frame src="<%=path%>/forwardPostOfferOrgSelect_urss.do" name="offerSelectFrame" scrolling="NO" noresize>
	  <frame src="<%=path%>//forwardPostOrgSelectHandle_urss" name="selectHandleFrame" scrolling="NO" noresize>
	  <frame src="<%=path%>/forwardPostSelectOrg_urss.do" name="selectedFrame" scrolling="NO" noresize id="selectedFrame">
   </frameset>
  <frame src="<%=path%>/forwardPostBottomOrg_urss.do" name="bottomFrame" scrolling="NO" noresize id="bottomFrame">
</frameset>
<noframes><body>
</body></noframes>
</html>
