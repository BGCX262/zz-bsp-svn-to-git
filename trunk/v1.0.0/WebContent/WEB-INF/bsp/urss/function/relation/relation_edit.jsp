...
<html>
	...
	<html:form action="/saveResource_urss.do"   styleId="resourceEdit" method="post">
			<tr class="ListTableRow">
				...
				<td width="16%" >分组名称：</td>
				<td width="29%">
						<html:text name="ResourceForm" styleClass="formStyleall"  property="groupName" styleId="groupName"  size="30" /><%=red%>
			  ...
			  <tr class="ListTableRow">	
				...
				<td width="29%" colspan="3">
					<html:text name="ResourceForm" styleClass="formStyleall"  property="implJs" styleId="implJs"  size="60" />
				</td>
			  </tr>
			  ...
			  <tr class="ListTableRow">	
				...
				<td width="35%">			   
				  ...
				  <html:text name="ResourceForm" styleClass="formStyleall"  property="coopAreaIdName" styleId="coopAreaIdName"  size="30"/>
				</td>
			  ...
			  <tr class="ListTableRow">	
			   ...
			   <tr class="ListTableRow">	
				...
				<td width="16%" >排序号：</td>
				<td width="29%" colspan="1">
				<html:text name="ResourceForm" styleClass="formStyleall"  property="orderIndex" styleId="orderIndex"  size="6" />
