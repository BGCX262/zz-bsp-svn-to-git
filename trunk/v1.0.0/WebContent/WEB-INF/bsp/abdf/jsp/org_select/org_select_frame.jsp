...
<frameset rows="*,40" frameborder="no" border="0" framespacing="0">
  <frameset cols="*,75,*" frameborder="no" border="0" framespacing="0">
      <frame src="<%=path%>/forwardOfferOrgSelect_abdf.do" name="offerSelectFrame" scrolling="NO" noresize>
      <frame src="<%=path%>/forwardSelectHandle_abdf.do" name="selectHandleFrame" scrolling="NO" noresize>
      <frame src="<%=path%>/forwardSelectedOrg_abdf.do" name="selectedFrame" scrolling="NO" noresize id="selectedFrame">
   </frameset>
  <frame src="<%=path%>/forwardBottomOrg_abdf.do" name="bottomFrame" scrolling="NO" noresize id="bottomFrame">
</frameset>
<noframes><body>
</body></noframes>
</html>
