...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction,sDblAction,eParent, sIcon, sOpenIcon) {
    // call super
    this.WebFXTreeItem = WebFXTreeItem;
    this.WebFXTreeItem(sText, sAction, sDblAction, eParent, sIcon, sOpenIcon);
...
function _xmlTreeToJsTree(oNode) {
    ...
    /**jwz***/
    var dblAction=oNode.getAttribute("dblAction");
    var parent = null;
    ...
    var jsNode;
    if (src != null && src != "")
        jsNode = new WebFXLoadTreeItem(text, src, action,dblAction, parent, icon, openIcon);
    else
        jsNode = new WebFXTreeItem(text, action, dblAction,parent, icon, openIcon);
