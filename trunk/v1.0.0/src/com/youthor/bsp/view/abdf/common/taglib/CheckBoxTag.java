     ...
     public int doStartTag() {
        ...
        public int doEndTag() throws JspException {
            ...
            if(dynamic)
             {
                 try {
                    buf.append(CheckBoxHtmlHelper.getHtmlByDynamic(this.dictType, this.defaultValue,this.addBr,this.onchange,this.onclick,this.property,this.disabled, request));
                } catch (Exception e) {
            ...
            {
                try {
                    buf.append(CheckBoxHtmlHelper.getHtmlByDict(this.dictType,this.valueType,this.defaultValue,this.addBr,this.onchange,this.onclick,this.property,this.disabled,request));
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
