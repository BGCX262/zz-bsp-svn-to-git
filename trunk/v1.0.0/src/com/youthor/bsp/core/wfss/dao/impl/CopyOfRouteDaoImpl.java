...
public class CopyOfRouteDaoImpl  extends BaseDAOHibernate implements  IRouteDao{
    ...
    public String addRoute(Route route) {
        ...
        routeTemp.setIsPointToEnd("setIsPointToEnd");
        super.doCreateObject(routeTemp);
        return routeTemp.getRouteId();
    }
